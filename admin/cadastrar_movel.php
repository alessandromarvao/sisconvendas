...
<head>
    ...
    <script src="js/cadastrar_moveis.js"></script>
        ...
        <div class="row">
            <div class="form-group col-md-8 col-lg-6">
                ...
                <form role="form" action="../php/cadastrar_movel.php" method="POST" enctype='multipart/form-data' id='form1'>
                    ...
                    <label>Modelo</label>
                    <input type="text" name="txtModelo" class="form-control" placeholder="Digite aqui o modelo do móvel com o tamanho, cor ou referência. Ex: HOME LIVIN 2.2 BRANCO BRILHANTE" />
                    <br class="visible-md visible-lg" />
                    ...
                    <select name="txtTipo" class="form-control" required >
                        ...
                        <option value='ARMARIO/ESCRIT�RIO'>ARMARIO /ESCRITÓRIO</option>
                        <option value='BALCÃO/AÇO'>BALC�O /AçO </option>
                        ...
                        <option value='CONJUNTO TERRAO'>CONJUNTO TERRAÇO</option>
                    ...
                    <br class="visible-md visible-lg" />
                    <label>Quantidade a ser adicionada no Estoque</label>
                    <input type="text" name="txtEstoque" class="form-control" value="0" />
                    <br class="visible-md visible-lg" />
