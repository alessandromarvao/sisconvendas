...
<body onload="enviaDados('obter', 'modelo')" class="bg_herdado">
    <div class="container content">
        <div class="row">
            <div class="col-md-8">
                <h2>Selecione o m�vel comprado</h2>
                <br />
                <label>Modelo</label>
                <input type="search" name="txtModelo" id="modelo" class="form-control" placeholder="Digite aqui o modelo do m�vel" onkeyup="enviaDados('obter', 'modelo')" />
