...
<head>
    ...
    <script src="js/selecionar_movel_compra.js"></script>
...
<body onload="enviaDados('obter', 'modelo')" class="bg_herdado">
    <div class="container content">
        <div class="row">
            <div class="col-md-8">
                <h2>Selecione o móvel comprado</h2>
                <br />
                <label>Modelo</label>
                <input type="search" name="txtModelo" id="modelo" class="form-control" placeholder="Digite aqui o modelo do móvel" onkeyup="enviaDados('obter', 'modelo')" />
    ...
    <div class="container content">
        <div class="row">
            <div class="col-sm-3">
                <a href="index.php" class="btn btn-lg btn-block btn-default spacing">
                    <span class="glyphicon glyphicon-remove"></span> Voltar</a>
            </div>
            <div class="col-sm-3">
                <a href="#" class="btn btn-lg btn-block btn-warning spacing">
