            ...
            <div class="col-sm-8">
                <div class="form-group col-md-10">
                    ...
                    <form role="form" method="POST">
                        ...
                        <div class="row">
                            <div class='col-md-4'>
                                <button type="button" class="btn btn-lg btn-block btn-success spacing" onclick="enviaDados('salvar', 'cpf')">
                                    <span class="glyphicon glyphicon-floppy-save"></span> Cadastrar
                                </button>
                            </div>
                            <div class='col-md-4'>
                                <button type="reset" class="btn btn-lg btn-block btn-default spacing">
                                    <span class="glyphicon glyphicon-erase"></span> Limpar
                                </button>
                            </div>
                            <div class='col-md-4'>
                                <a href="index.php" class="btn btn-lg btn-block btn-warning spacing" title="Cancela o cadastro e volta � pagina ininical">
