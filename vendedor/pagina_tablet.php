        ...
        <div class="container content">
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-8">
                    ...
                    <div class="row">
                        <div class=" col-xs-12 col-sm-6 spacing">
                            <a href="pesquisar_todos_moveis.php" class="btn btn-lg btn-block btn-default">Pesquisar Móveis no Estoque</a>
                        </div>
                ...
                <div class="col-sm-2 col-md-3 hidden-xs ">
                    <img src="../img/img_3_1080x1920.jpg" alt="Espaço Conforto." style="height: 100%" />
                </div>
            </div>
        </div>
    </body>
